...
namespace Lab2_task3
{
    public partial class Form1 : Form
    {
        ...
        private void productListBtn_Click(object sender, EventArgs e)
        {
            ...
            while (reader.Read())
            {
                productList.Items.Add(reader["ProductName"].ToString());
            }
        ...
        private void transactionBtn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                //Допущена ошибка в команде вставки
                //command.CommandText = "INSERT INTO qProducts (ProductName) VALasUES('Wrong size')";

                //Правильная команда вставки
